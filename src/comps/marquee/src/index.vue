<template>
  <div class="ht-marquee" :class="classes" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    <div class="ht-marquee__scroll" :style="scrollStyle">
      <div ref="content" class="ht-marquee__content">
        <slot></slot>
      </div>
      <div class="ht-marquee__copy-content" :style="copyStyle" v-html="copyHtml"></div>
    </div>
  </div>
</template>
...
import { requestAnimationFrame, cancelAnimationFrame } from "../../../utils/tools";

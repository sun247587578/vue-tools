<template>
  <div class="ht-particles" :style="styles">
    <div id="particles-js"></div>
    <div class="ht-particles">
      <slot></slot>
    </div>
  </div>
</template>
<script>
let particlesJS = require("./particles.min.js")
export default {
  name: "htParticles",
  props:{
    styles: {
  ...
  mounted(){
    window.particlesJS('particles-js',  this.partOpt);
  }
}
</script>
